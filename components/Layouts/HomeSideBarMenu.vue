...
const navClasses: ComputedRef<string> = computed<string>(() => isMobile ? 'flex-inline bottom-0 md:w-auto w-full': '-translate-y-2/4 flex-col top-2/4 left-3 rounded-lg border')
</script>
