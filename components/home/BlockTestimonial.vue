...
import type {BlockTestimonialDocument, BlockTestimonialDocumentData} from "~/prismicio-types";
...
<template>
  <!--Background-->
  <section
      class="rounded-md p-6 text-center shadow-lg md:p-12 md:text-left bg-gray-600"
  >
      ...
      <div class="grid gap-6 text-center md:grid-cols-3 lg:gap-12 ">
        <div class="mb-12 md:mb-0">
          ...
          <p class="mb-4 italic text-neutral-600 dark:text-neutral-300">
        ...
        <div class="mb-12 md:mb-0">
          <div class="mb-6 flex justify-center">
            <!--        <prismic-image-->
            <!--          :field="block.data.testimonial_vignette_3"-->
            <!--          class="w-32 rounded-full shadow-lg dark:shadow-black/30"-->
            <!--        />-->
          </div>
          <p class="mb-4 italic text-neutral-600 dark:text-neutral-300">
            <!--        <prismic-text :field="block.data.testimonial_text_2" />-->
        ...
        <div class="mb-0">
          ...
          <p class="mb-4 italic text-neutral-600 dark:text-neutral-300">
            <!--        <prismic-text :field="block.data.testimonial_text_3" />-->
