...
<template>
  <section class="px-40 flex flex-1 justify-center">
    <div
      v-if="error"
    ...
    >
      ...
      <div class="flex flex-wrap gap-4 px-4 mx-auto">
        ...
        >
          <div class="bg-white dark:bg-slate-800 relative top-0 p-3 sm:p-10">
            <Breadcrumbs
            ...
            >
              <span v-if="dataThematic.page_thematic.data.author">{{ $t("page.author") }}{{ dataThematic.page_thematic.data.author }}, </span>
